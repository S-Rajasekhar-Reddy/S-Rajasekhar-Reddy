...
#### 1. Network Automation Framework (Evolution of "Path Tracer")
*A modular Python-based tool for network observability and configuration management.*
- **Context:** Inspired by my work on "Path Tracer," an award-winning tool that reduced manual packet flow analysis time by **99.98%**.
- **Tech:** Python, Netmiko, Jinja2, Pandas.
- **Key Features:** Automated configuration backup, compliance auditing, and connectivity validation.

#### 2. SysAdmin & Network Utilities
*A collection of production-ready Bash scripts for system health and log management.*
- **Context:** Tools designed to optimize device memory usage ("Capture Cleaner") and automate routine maintenance.
- **Tech:** Bash, Shell, Cron, Linux.
- **Key Features:** Log rotation, disk usage alerting, and connectivity health checks.
